...
namespace AgroPlanning\TagBundle\Controller;
...
use AgroPlanning\TagBundle\Entity\Tag;
use AgroPlanning\TagBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AgroPlanningTagBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("AgroPlanningTagBundle:Tag:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $entity = $em->getRepository('AgroPlanningTagBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AgroPlanningTagBundle:Tag:edit.html.twig")
     */
